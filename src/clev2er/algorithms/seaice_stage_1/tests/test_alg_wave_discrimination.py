...
clev2er.algorithms.seaice_stage_1.alg_cs2_wave_discrimination.py
"""
...
from clev2er.algorithms.seaice_stage_1.alg_cs2_wave_discrimination import Algorithm
...
def test_cs2_wave_discrimination() -> None:
    ...
    # load config
    config, _, _, _, _ = load_config_files("seaice_stage_1")
